...
namespace Timecare.Controllers
{
    public class WorkSchedulesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Description,StartTime,EndTime")] WorkSchedule workSchedule)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Description,StartTime,EndTime")] WorkSchedule workSchedule)
        {
            if (ModelState.IsValid)
            {
